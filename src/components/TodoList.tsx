...
export default function TodoList() {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#06111BE6" }}
    >
      <div className="w-full max-w-md bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
        {/* Header with title */}
        <h1 className="text-2xl font-bold mb-4 text-[#BB9040] dark:text-gray-200 text-center uppercase">
          Todo List
        </h1>
        ...
        <div className="flex flex-col md:flex-row items-center mb-4">
          <Input
            ...
            className="flex-1 mb-2 md:mb-0 md:mr-2 px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200"
          />
          <Button
            onClick={addTask}
            className="bg-[#BB9040] hover:bg-yellow-500 text-white font-medium py-2 px-4 rounded-md"
          >
            Add
          </Button>
        </div>
            ...
            >
              ...
              <div className="flex items-center">
                {editingTaskId === task.id ? (
                  ...
                  <Button
                    onClick={updateTask}
                    className="bg-green-500 hover:bg-green-600 text-white font-medium py-1 px-2 rounded-md mr-2"
                  >
                    Save
                  </Button>
                ) : (
